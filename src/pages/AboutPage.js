          ...
          <div className="row">
            ...
            <div className="col-md-7 p-3">
              <div className="row">
                <h4>About Me</h4>
                <p>
                  I am a javascript developer, who enjoys writing javascript
                  code. The first time i got know coding was in may 2021,
                  exactly a year ago. At first i was self-taught, then in
                  december 2021, i attended a fullstack bootcamp at eduwork.id
                  and took an M.E.R.N. technology class
                </p>
              </div>
              <div className="row">
                <h4>Github</h4>
